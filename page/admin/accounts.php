                            ...
                            <div class="row mt-1 align-items-center">
                                <div class="col-md-2 d-flex justify-content-center">
                                    <button class="btn btn-success custom-btn" id="openModalBtn" data-toggle="modal"
                                        data-target="#addRecordModal" style="height: 35px; width: 100%; background-color:#3d3b3e; border-color:black;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Handle opening modal for adding/editing account
    ...
    // Form submission (Add/Update Account)
    ...
    // Delete selected accounts when the delete button is clicked
    deleteBtn.addEventListener('click', () => {
        ...
        // Call the delete API with selected IDs
