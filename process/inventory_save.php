...
$sql = "INSERT INTO fgls_output (container_no, pallet_no, position, remarks, poly_size, poly_qty, id_scanned, date_scan, judgement, dt) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

$stmt = mysqli_prepare($conn, $sql);

// Updated to match the SQL query structure
mysqli_stmt_bind_param($stmt, "ssssssssss", $container_no, $pallet_no, $position, $remarks, $poly_size, $poly_qty, $id_scanned, $date_scan, $judgement, $dt);
